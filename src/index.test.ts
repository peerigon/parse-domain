...
describe("parseDomain()", () => {
	test("splits a hostname into subdomain, domain and top-level domain", () => {
	...
	test("returns undefined as subdomain if the hostname has no subdomain", () => {
	...
	test("returns undefined as domain if the hostname is a top-level domain", () => {
	...
	test("returns undefined as tld if the hostname does not contain a known top-level domain", () => {
	...
	test("passes the official test suite from https://raw.githubusercontent.com/publicsuffix/list/master/tests/test_psl.txt", () => {
